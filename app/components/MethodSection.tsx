...
const steps: Step[] = [
  {
    ...
    title: "Find the real problem and what needs to change.",
  ...
  },
  {
    ...
    title: "Test assumptions before making expensive decisions.",
  ...
  },
  {
    ...
    label: "MAKE",
    step: "STEP 3 / MAKE",
    title: "Turn the direction into something people can experience.",
